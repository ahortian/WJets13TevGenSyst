...
//    TH1D* newTH1D(string, string, string, vector<double>&);
    ...
    GenH1D *genZNGoodJetsFull_Zexc;
    TH2D *hresponseZNGoodJetsFull_Zexc;
    TH1D *ZNGoodJetsFull_Zinc;
    GenH1D *genZNGoodJetsFull_Zinc;
    ...
    GenH1D *genSecondJetPt_1_Zinc2jet;
    GenH1D *genSecondJetPt_2_Zinc2jet;
    GenH1D *genThirdJetPt_Zinc3jet;
    GenH1D *genThirdJetPt_1_Zinc3jet;
    GenH1D *genThirdJetPt_2_Zinc3jet;
    GenH1D *genFourthJetPt_Zinc4jet;
    GenH1D *genFourthJetPt_1_Zinc4jet;
    GenH1D *genFourthJetPt_2_Zinc4jet;
    ...
    GenH1D *genJetsHT_20_Zinc1jet;
    GenH1D *genJetsHT_20_Zinc2jet;
    GenH1D *genJetsHT_20_Zinc3jet;
    GenH1D *genJetsHT_20_30_Zinc1jet;
    GenH1D *genJetsHT_20_30_Zinc2jet;
    GenH1D *genJetsHT_20_30_Zinc3jet;
    GenH1D *genJetsHT_Zinc4jet;
    GenH1D *genJetsHT_Zinc5jet;
    GenH1D *genJetsHT_Zinc6jet;
    GenH1D *genJetsHT_1_Zinc1jet;
    GenH1D *genJetsHT_1_Zinc2jet;
    GenH1D *genJetsHT_1_Zinc3jet;
    GenH1D *genJetsHT_1_Zinc4jet;
    GenH1D *genJetsHT_1_Zinc5jet;
    GenH1D *genJetsHT_1_Zinc6jet;
    GenH1D *genJetsHT_2_Zinc1jet;
    GenH1D *genJetsHT_2_Zinc2jet;
    GenH1D *genJetsHT_2_Zinc3jet;
    GenH1D *genJetsHT_2_Zinc4jet;
    GenH1D *genJetsHT_2_Zinc5jet;
    GenH1D *genJetsHT_2_Zinc6jet;
    ...
    GenH1D *gendPhiLepJet1_Zinc1jet;
    GenH1D *gendPhiLepJet2_Zinc2jet;
    GenH1D *gendPhiLepJet3_Zinc3jet;
    GenH1D *gendPhiLepJet4_Zinc4jet;
    GenH1D *gendPhiLepJet5_Zinc5jet;
    GenH1D *gendPhiLepJet1_2_Zinc1jet;
    GenH1D *gendPhiLepJet2_2_Zinc2jet;
    GenH1D *gendPhiLepJet3_2_Zinc3jet;
    GenH1D *gendPhiLepJet4_2_Zinc4jet;
    GenH1D *gendPhiLepJet5_2_Zinc5jet;
	...
	GenH1D *gendRLepCloseJet_Zinc1jet;
	GenH1D *gendRLepCloseJet_2_Zinc1jet;
	...
	GenH1D *gendRLepCloseJetCo_Zinc1jet;
	GenH1D *gendRLepCloseJetCo_2_Zinc1jet;
	...
	GenH1D *gendRptmin100LepCloseJetCo300dR04_Zinc1jet;
	GenH1D *gendRptmin100LepCloseJetCo300dR04_2_Zinc1jet;
	...
	GenH1D *gendRptmin100LepCloseDiJetCo300dR04_Zinc2jet;
	GenH1D *gendRptmin100LepCloseDiJetCo300dR04_2_Zinc2jet;
    ...
    GenH1D *genFirstJetAbsRapidity_2_Zinc1jet;
    GenH1D *genSecondJetAbsRapidity_2_Zinc2jet;
    GenH1D *genThirdJetAbsRapidity_2_Zinc3jet;
    GenH1D *genFourthJetAbsRapidity_2_Zinc4jet;
    GenH1D *genFifthJetAbsRapidity_2_Zinc5jet;
