...
//        }
 ...
 if (DEBUG) cout << "Stop after line " << __LINE__ << endl;
    ...
    table TableJESunc("EfficiencyTables/JECUncertainty_Fall15_25nsV2_AK4PF.txt");
    if (energy == "13TeV"){
 ...
 if (DEBUG) cout << "Stop after line " << __LINE__ << endl;
	...
	double sum_amcNLO_W = 0. ;
	double sum_amcNLO_1 = 0. ;
...
//            }
		...
		if (hasRecoInfo){
			if (energy == "13TeV" && doW && ((TrigHltMu & 1LL<<12) || (TrigHltMu & 1LL<<19))) countEventpassTrig++;
...
//                }
                ...
                genZNGoodJetsFull_Zexc->Fill(nGoodGenJets, genWeight, mcEventWeight_);
                genZNGoodJets_Zinc->Fill(0., genWeight, mcEventWeight_);
                genZNGoodJetsFull_Zinc->Fill(0., genWeight, mcEventWeight_);
                ...
                if (nGoodGenJets_20 >= 1){
                    genFirstJetPt_Zinc1jet  ->Fill(genJets_20[0].pt, genWeight, mcEventWeight_);
                    genFirstJetPt_1_Zinc1jet->Fill(genJets_20[0].pt, genWeight, mcEventWeight_);
                    genFirstJetPt_2_Zinc1jet->Fill(genJets_20[0].pt, genWeight, mcEventWeight_);
                    genJetsHT_20_Zinc1jet->Fill(genJetsHT_20, genWeight, mcEventWeight_);
                }
                if (nGoodGenJets_20 >= 2){
                    genSecondJetPt_Zinc2jet  ->Fill(genJets_20[1].pt, genWeight, mcEventWeight_);
                    genSecondJetPt_1_Zinc2jet->Fill(genJets_20[1].pt, genWeight, mcEventWeight_);
                    genSecondJetPt_2_Zinc2jet->Fill(genJets_20[1].pt, genWeight, mcEventWeight_);
                    genJetsHT_20_Zinc2jet->Fill(genJetsHT_20, genWeight, mcEventWeight_);
                }
                if (nGoodGenJets_20 >= 3){
                    genThirdJetPt_Zinc3jet  ->Fill(genJets_20[2].pt, genWeight, mcEventWeight_);
                    genThirdJetPt_1_Zinc3jet->Fill(genJets_20[2].pt, genWeight, mcEventWeight_);
                    genThirdJetPt_2_Zinc3jet->Fill(genJets_20[2].pt, genWeight, mcEventWeight_);
                    genJetsHT_20_Zinc3jet->Fill(genJetsHT_20, genWeight, mcEventWeight_);
                }
                if (nGoodGenJets_20 >= 4){
                    genFourthJetPt_Zinc4jet  ->Fill(genJets_20[3].pt, genWeight, mcEventWeight_);
                    genFourthJetPt_1_Zinc4jet->Fill(genJets_20[3].pt, genWeight, mcEventWeight_);
                    genFourthJetPt_2_Zinc4jet->Fill(genJets_20[3].pt, genWeight, mcEventWeight_);
                }
                if (nGoodGenJets_20 >= 5){
                    genFifthJetPt_Zinc5jet  ->Fill(genJets_20[4].pt, genWeight, mcEventWeight_);
                    genFifthJetPt_1_Zinc5jet->Fill(genJets_20[4].pt, genWeight, mcEventWeight_);
                    genFifthJetPt_2_Zinc5jet->Fill(genJets_20[4].pt, genWeight, mcEventWeight_);
                }
                if (nGoodGenJets_20 >= 6){
                    genSixthJetPt_Zinc6jet  ->Fill(genJets_20[5].pt, genWeight, mcEventWeight_);
                    genSixthJetPt_1_Zinc6jet->Fill(genJets_20[5].pt, genWeight, mcEventWeight_);
                }
				if (nGenJetsDR02Cut >= 1){
					gendRLepCloseJet_Zinc1jet  ->Fill(genMindRjmu, genWeight, mcEventWeight_);
					gendRLepCloseJet_2_Zinc1jet->Fill(genMindRjmu, genWeight, mcEventWeight_);
					if(genJetsDR02[0].pt > 500){
						gendRLepCloseJetCo_Zinc1jet  ->Fill(genMindRjmu, genWeight, mcEventWeight_);
						gendRLepCloseJetCo_2_Zinc1jet->Fill(genMindRjmu, genWeight, mcEventWeight_);
					}
				}
				
				if (nGenJetsPt100DR04 >= 1 && genJetsPt100DR04[0].pt > 300){
					gendRptmin100LepCloseJetCo300dR04_Zinc1jet  ->Fill(genMindRj04Pt100mu, genWeight, mcEventWeight_);
					gendRptmin100LepCloseJetCo300dR04_2_Zinc1jet->Fill(genMindRj04Pt100mu, genWeight, mcEventWeight_);
				}

				if (nGenJetsPt100DR04 >= 2 && genJetsPt100DR04[0].pt > 300 && deltaPhi(genLeadJ, genSecondJ) > (PI - 0.3)){
					gendRptmin100LepCloseDiJetCo300dR04_Zinc2jet  ->Fill(genMindRdijet04Pt100mu, genWeight, mcEventWeight_);
					gendRptmin100LepCloseDiJetCo300dR04_2_Zinc2jet->Fill(genMindRdijet04Pt100mu, genWeight, mcEventWeight_);
				}
                ...
                if (nGoodGenJets >= 1){
                    ...
                    //*************************************** begin edit *************************************************************//
                    genFirstJetAbsRapidity_Zinc1jet->Fill(fabs(genNewLeadJ.Rapidity()), genWeight, mcEventWeight_);
                    genFirstJetAbsRapidity_2_Zinc1jet->Fill(fabs(genNewLeadJ.Rapidity()), genWeight, mcEventWeight_);
                    ...
                    genJetsHT_20_30_Zinc1jet->Fill(genJetsHT_20, genWeight, mcEventWeight_);
                    genJetsHT_1_Zinc1jet->Fill(genJetsHT, genWeight, mcEventWeight_);
                    genJetsHT_2_Zinc1jet->Fill(genJetsHT, genWeight, mcEventWeight_);
                    
					gendPhiLepJet1_Zinc1jet->Fill(deltaPhi(genLep1, genNewLeadJ), genWeight, mcEventWeight_);
					gendPhiLepJet1_2_Zinc1jet->Fill(deltaPhi(genLep1, genNewLeadJ), genWeight, mcEventWeight_);
                ...
                if (nGoodGenJets >= 2){
                    ...
                    genZNGoodJetsFull_Zinc->Fill(2., genWeight, mcEventWeight_);
                    ...
                    //*************************************** begin edit *******************************************************//
                    genSecondJetAbsRapidity_Zinc2jet->Fill(fabs(genNewSecondJ.Rapidity()), genWeight, mcEventWeight_);
                    genSecondJetAbsRapidity_2_Zinc2jet->Fill(fabs(genNewSecondJ.Rapidity()), genWeight, mcEventWeight_);
					...
					gendPhiLepJet2_Zinc2jet->Fill(deltaPhi(genLep1, genNewSecondJ), genWeight, mcEventWeight_);
					gendPhiLepJet2_2_Zinc2jet->Fill(deltaPhi(genLep1, genNewSecondJ), genWeight, mcEventWeight_);
                    ...
                    genJetsHT_20_30_Zinc2jet->Fill(genJetsHT_20, genWeight, mcEventWeight_);
                    genJetsHT_1_Zinc2jet->Fill(genJetsHT, genWeight, mcEventWeight_);
                    genJetsHT_2_Zinc2jet->Fill(genJetsHT, genWeight, mcEventWeight_);
                ...
                if (nGoodGenJets >= 3){
                    ...
                    genZNGoodJetsFull_Zinc->Fill(3., genWeight, mcEventWeight_);
                    ...
                    //*************************************** begin edit *************************************************************//
                    genThirdJetAbsRapidity_Zinc3jet->Fill(fabs(genNewThirdJ.Rapidity()), genWeight, mcEventWeight_);
                    genThirdJetAbsRapidity_2_Zinc3jet->Fill(fabs(genNewThirdJ.Rapidity()), genWeight, mcEventWeight_);
					...
					gendPhiLepJet3_Zinc3jet->Fill(deltaPhi(genLep1, genNewThirdJ), genWeight, mcEventWeight_);
					gendPhiLepJet3_2_Zinc3jet->Fill(deltaPhi(genLep1, genNewThirdJ), genWeight, mcEventWeight_);
                    //*************************************** end edit ***************************************************************//
                    ...
                    genJetsHT_20_30_Zinc3jet->Fill(genJetsHT_20, genWeight, mcEventWeight_);
                    genJetsHT_1_Zinc3jet->Fill(genJetsHT, genWeight, mcEventWeight_);
                    genJetsHT_2_Zinc3jet->Fill(genJetsHT, genWeight, mcEventWeight_);
                    
                }
                if (nGoodGenJets >= 4){
                    genZNGoodJets_Zinc->Fill(4., genWeight, mcEventWeight_);
                    genZNGoodJetsFull_Zinc->Fill(4., genWeight, mcEventWeight_);
                    ...
                    //*************************************** begin edit *************************************************************//
                    genFourthJetAbsRapidity_Zinc4jet->Fill(fabs(genNewFourthJ.Rapidity()), genWeight, mcEventWeight_);
                    genFourthJetAbsRapidity_2_Zinc4jet->Fill(fabs(genNewFourthJ.Rapidity()), genWeight, mcEventWeight_);
					...
					gendPhiLepJet4_Zinc4jet->Fill(deltaPhi(genLep1, genNewFourthJ), genWeight, mcEventWeight_);
					gendPhiLepJet4_2_Zinc4jet->Fill(deltaPhi(genLep1, genNewFourthJ), genWeight, mcEventWeight_);
                    //*************************************** end edit ***************************************************************//
                    ...
                    genJetsHT_1_Zinc4jet->Fill(genJetsHT, genWeight, mcEventWeight_);
                    genJetsHT_2_Zinc4jet->Fill(genJetsHT, genWeight, mcEventWeight_);
                }
                if (nGoodGenJets >= 5){
                    genZNGoodJets_Zinc->Fill(5., genWeight, mcEventWeight_);
                    genZNGoodJetsFull_Zinc->Fill(5., genWeight, mcEventWeight_);
                    ...
                    genJetsHT_1_Zinc5jet->Fill(genJetsHT, genWeight, mcEventWeight_);
                    genJetsHT_2_Zinc5jet->Fill(genJetsHT, genWeight, mcEventWeight_);
                ...
                if (nGoodGenJets >= 6){
                    ...
                    genZNGoodJetsFull_Zinc->Fill(6., genWeight, mcEventWeight_);
                    ...
                    genJetsHT_1_Zinc6jet->Fill(genJetsHT, genWeight, mcEventWeight_);
                }
                if (nGoodGenJets >= 7){
                    genZNGoodJets_Zinc->Fill(7., genWeight, mcEventWeight_);
                    genZNGoodJetsFull_Zinc->Fill(7., genWeight, mcEventWeight_);
                }
                
                if (nGoodGenJets >= 8) genZNGoodJets_Zinc->Fill(8., genWeight, mcEventWeight_);
                if (doW && nGoodGenJets >= 9) genZNGoodJets_Zinc->Fill(9., genWeight, mcEventWeight_);
                if (doW && nGoodGenJets >= 10) genZNGoodJets_Zinc->Fill(10., genWeight, mcEventWeight_);
            }
        }
...
//            }
	...
	cout << " allSampEvtWSums[0] " << allSampEvtWSums[0] << " allBonzEvtWSums[0] "<< allBonzEvtWSums[0] << " allSampEvtWSums[1] " << allSampEvtWSums[1] << " allBonzEvtWSums[1] "<< allBonzEvtWSums[1]<< endl;
	...
	cout << "sum_amcNLO_W fill                              : " << sum_amcNLO_W << endl;
	cout << "sum_amcNLO_1 fill                              : " << sum_amcNLO_1 << endl;
...
void ZJetsAndDPS::getMcNorm_amcNLO(string inFile_Name){
	...
	fullFileName += ".txt";
	std::ifstream ifs;
	ifs.open (fullFileName.c_str(), std::ifstream::in);
	cout << " filename " << fullFileName << " " << ifs.is_open() << endl;
	
	string line;
	int countFiles(0);
	while (getline(ifs, line)){
		TH1D *inHist, *inHist2;
		TH1D *countEvtSamHist, *countEvtBonHist, *sumEvtSamWghtHist, *sumEvtBonWghtHist;
		...
		inHist2= (TH1D*)f->Get("demo/hWeights_1002");
		countEvtSamHist   = (TH1D*)f->Get("demo/countEventSample");
		countEvtBonHist   = (TH1D*)f->Get("demo/countEventBonzai");
		sumEvtSamWghtHist = (TH1D*)f->Get("demo/sumEventWeightSample");
		sumEvtBonWghtHist = (TH1D*)f->Get("demo/sumEventWeightBonzai");
		
		allSampEvtWSums[0] += inHist->GetBinContent(1);
		allBonzEvtWSums[0] += inHist->GetBinContent(2);
		
		allSampEvtWSums[1] += inHist2->GetBinContent(1);
		allBonzEvtWSums[1] += inHist2->GetBinContent(2);
		
		countAllSamp[0] += countEvtSamHist->GetBinContent(1);
		countAllSamp[1] += sumEvtSamWghtHist->GetBinContent(1);
		
		countAllBonz[0] += countEvtBonHist->GetBinContent(1);
		countAllBonz[1] += sumEvtBonWghtHist->GetBinContent(1);
